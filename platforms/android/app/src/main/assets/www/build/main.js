...
var ConectorProvider = /** @class */ (function () {
    function ConectorProvider(http) {
        this.http = http;
        //Localhost
        this.host = "http://192.25.8.113/ionic/";
